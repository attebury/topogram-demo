...
- `cap_sign_in_account` at `POST /api/auth/login`
...
- `account_journey` (journey) from `config/routes.rb#POST /api/auth/login`, `app/controllers/authentication_controller.rb`
