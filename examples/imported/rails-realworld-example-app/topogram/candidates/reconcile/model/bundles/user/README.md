...
- `entity_user` from `db/schema.rb`

## API Evidence

- `cap_create_user` at `POST /api/users`
- `cap_get_user` at `GET /api/users/{id}`
...
- `user_journey` (journey) from `config/routes.rb#GET /api/users/:id`, `config/routes.rb#GET /api/user`
