...
- `article`: blocked=0, approved=0, applied=27, pending=0, dependencies=_none_
...
- `user`: blocked=0, approved=0, applied=13, pending=0, dependencies=_none_
...
- `article` (0 actors, 0 roles, 1 entities, 0 enums, 8 capabilities, 15 shapes, 0 screens, 1 workflows, 1 docs)
  ...
  - main routes _none_
  - candidate maintained seam mappings _none_
  - permission hints permission `api.create` (medium), permission `api.favorite_article` (medium), permission `api.feed_article` (medium), permission `api.unfavorite_article` (medium)
  - auth claims _none_
  - ownership hints _none_
  - auth role guidance _none_
...
- `tag` (0 actors, 0 roles, 1 entities, 0 enums, 1 capabilities, 1 shapes, 0 screens, 1 workflows, 1 docs)
  ...
  - main routes _none_
  - candidate maintained seam mappings _none_
  - permission hints permission `api.read` (medium)
  - auth claims _none_
  - ownership hints _none_
  - auth role guidance _none_
...
- `user` (0 actors, 0 roles, 1 entities, 0 enums, 3 capabilities, 6 shapes, 0 screens, 1 workflows, 1 docs)
