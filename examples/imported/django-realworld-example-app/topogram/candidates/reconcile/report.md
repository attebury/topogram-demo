...
- `article`: blocked=0, approved=0, applied=24, pending=0, dependencies=_none_
- `comment`: blocked=0, approved=0, applied=10, pending=0, dependencies=_none_
- `profile`: blocked=0, approved=0, applied=12, pending=0, dependencies=_none_
...
- `article` (1 entities, 0 enums, 7 capabilities, 14 shapes, 0 screens, 1 workflows, 0 docs)
- `comment` (1 entities, 0 enums, 3 capabilities, 4 shapes, 0 screens, 1 workflows, 0 docs)
- `profile` (1 entities, 0 enums, 3 capabilities, 6 shapes, 0 screens, 1 workflows, 0 docs)
- `tag` (1 entities, 0 enums, 1 capabilities, 2 shapes, 0 screens, 1 workflows, 0 docs)
...
- `candidates/reconcile/model/bundles/comment/shapes/shape_input_list_comments.tg`
...
- `candidates/reconcile/model/bundles/profile/shapes/shape_input_get_profile.tg`
- `candidates/reconcile/model/bundles/profile/shapes/shape_input_unfollow_profile.tg`
...
- `candidates/reconcile/model/bundles/tag/shapes/shape_input_list_tags.tg`
